      ...
      <div className="card-body d-flex flex-column">
        ...
        <div className="mb-3">
          <div className="d-flex justify-content-between mb-2 small align-items-center">
            <div className={`enrolled-badge ${isNearFull ? "near-full" : ""}`}>
              ...
              <span>จองแล้ว {enrolled} / {max}</span>
            </div>
            <span className={`fw-bold ${isNearFull ? "text-danger" : "text-primary"}`}>{Math.round(percentFull)}%</span>
          </div>
