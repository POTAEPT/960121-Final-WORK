      ...
      <div className="card-body d-flex flex-column">
        ...
        <div className="mb-3">
          <div className="d-flex justify-content-between mb-1 small" style={{ color: "var(--text-muted)" }}>
            <span>จองแล้ว: <strong className="text-white">{enrolled}</strong> / {max} ที่นั่ง</span>
            <span className={percentFull > 85 ? "text-danger fw-bold" : ""}>{Math.round(percentFull)}%</span>
          </div>
